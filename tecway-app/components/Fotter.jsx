...
const Footer = () => {
  return (
    <footer className="flex flex-col items-center justify-center px-4 sm:px-6 md:px-10 min-h-[400px] sm:min-h-[500px] md:h-[600px] py-8 sm:py-10 md:py-0 bg-gradient-to-b from-black via-[#e064229f] to-[#ee741e] overflow-hidden relative">
      {/* Content */}
