...
const faqs = [
  {
    ...
    answer: "We build mobile applications, websites, custom software systems, chatbot solutions (AI-powered and rule-based), and provide full UI/UX design services.",
  },
  {
    id: "2",
    question: "Which industries do you work with?",
    answer: "We work across multiple industries including healthcare, finance, e-commerce, logistics, education, startups, and enterprise systems.",
  },
  {
    id: "3",
    question: "How much does it cost to build a mobile app or website?",
    answer: "Pricing depends on the project scope, features, complexity, and timeline. We provide a free consultation and send a detailed quote based on your requirements.",
  },
  {
    id: "4",
    question: "How long will it take to build my project?",
    answer: "Most websites take 2–6 weeks, mobile apps 1–3 months, and complex systems may take longer. A timeline is shared after requirement analysis.",
  },
  {
    id: "5",
  ...
  },
  {
    ...
    answer: "Absolutely. We integrate AI models, payment gateways, CRM systems, ERPs, and custom APIs.",
  },
  {
    id: "9",
    question: "Do you provide hosting and deployment?",
    answer: "Yes, we handle cloud hosting (AWS, Supabase, Firebase, Vercel), backend setup, CI/CD pipelines, and security.",
  },
  {
    id: "10",
